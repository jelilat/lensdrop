...
const Board = ({ airdrops, totalMatic, percentageIncrease, sponsoredPosts, followData, totalRecipients }: props) => {
    ...
    return(
        ...
        <div className="max-h-screen">
            <div className="flex my-10 sm:my-5 mx-3">
                <div className="rounded-2xl shadow-xl border-gray-400 h-fit mx-2 p-10 lg:mr-5 lg:w-72 w-1/3 sm:p-5">
                    <Cash className="w-10 h-10 my-1 sm:w-5"
                        strokeWidth={2}
                        color="#61acf9"
                        />
                ...
                <div className="rounded-2xl shadow-xl border-gray-400 h-fit mx-2 p-10 sm:p-5 lg:mr-5 lg:w-72 w-1/3">
                    <AirBalloon className="w-10 h-10 my-1 sm:w-5"
                        strokeWidth={2}
                        color="#61acf9"
                        />
                    <div className="font-bold text-3xl my-3 sm:my-1 sm:text-lg">
                ...
                <div className="rounded-2xl shadow-xl border-gray-400 h-fit mx-2 p-10 sm:p-5 lg:mr-5 w-1/3 lg:w-72">
                    <UserGroupIcon className="w-10 h-10 my-1 sm:w-5"
                        strokeWidth={2}
                        color="#61acf9"
                        />
                    <div className="font-bold text-3xl my-3 sm:my-1 sm:text-lg">
            ...
            <div className="lg:flex my-10 mx-3 sm:block">
                <div className="block sm:flex sm:my-5">
                    <div className="rounded-2xl shadow-xl border-gray-400 h-fit mx-2 p-10 sm:p-5 sm:w-1/2 lg:w-72">
                        <UserIcon className="w-10 h-10 my-1 sm:w-5"
                            strokeWidth={2}
                            color="#61acf9"
                            />
                        <div className="font-bold text-3xl my-3 sm:my-1 sm:text-lg">
                    ...
                    <div className="rounded-2xl shadow-xl border-gray-400 h-fit mx-2 p-10 sm:p-5 lg:mr-5 w-full sm:w-1/2 lg:w-72">
                        <Ticket className="w-10 h-10 my-1 sm:w-5"
                            strokeWidth={2}
                            color="#61acf9"
                            />
                        <div className="font-bold text-3xl my-3 sm:my-1 sm:text-lg">
                ...
                <div className="rounded-2xl shadow-xl border-gray-400 h-full mx-2 sm:my-5 p-10 sm:p-3 lg:mr-5 sm:w-full w-2/3">
