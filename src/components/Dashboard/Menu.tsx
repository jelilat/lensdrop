        ...
        <>
            <div className="">
                <nav className="p-2 rounded-3xl m-10 mt-1 bg-gradient-to-r from-cyan-300 to-blue-400 shadow-xl h-screen">
                    <Link className="flex font-bold items-center px-2 py-2 mt-5 mb-10 text-white group" href="/">
                        Lensdrop
                    </Link>
                    <Link className={`flex items-center justify-center p-2 text-white group ${router.pathname == '/dashboard' && "border-l-2 border-white"}`} href="/dashboard">
                    ...
                    <Link className={`flex items-center justify-center p-2 mt-4 text-white group ${router.pathname == '/dashboard/airdrops' && "border-l-2 border-white"}`} href="/dashboard/airdrops">
                    ...
                    <Link className={`flex items-center justify-center p-2 mt-4 text-white group ${router.pathname == '/dashboard/sponsored-posts' && "border-l-2 border-white"}`} href="/dashboard/sponsored-posts">
                    ...
                    <Link className={`flex items-center justify-center p-2 mt-4 text-white group ${router.pathname == '/dashboard/analytics' && "border-l-2 border-white"}`} href="/dashboard/analytics">
